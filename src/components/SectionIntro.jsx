        ...
        <div className="w-full py-12 z-10 absolute px-6 md:px-24" >
            <div className="content flex justify-center items-center md:flex-row flex-col gap-6 md:gap-40">
                ...
                <div className="details-section flex-col  max-w-md">
                    <h2 id="harper-bold" className=" mb-6 md:mb-12 text-4xl md:text-6xl font-bold">
                        Not the usual knowledge from the internet
                    </h2>

                    <div className="refferal-section">
                        <p className=" mb-4 md:mb-8 text-xl md:text-2xl font-bold">Cognition is packed with tried and tested practical insights and theories on writing, freelancing, and content creation.</p>
